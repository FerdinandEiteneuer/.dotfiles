...
ROFI_TEXT="${ROFI_TEXT:-Action}"
ROFI_OPTIONS=(${ROFI_OPTIONS:--width 11 -location center -hide-scrollbar -bw 2})
...
menu=(
  ...
  [Lock]="${LOCKSCRIPT:-~/.config/i3/scripts/lock/lock.sh --color=${BG_COLOR#"#"}}"
